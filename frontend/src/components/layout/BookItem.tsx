...
function BookItem({ book, setBookFormMode }: BookItemProps) {
  ...
  // Separate card content so that we can use a tertiary operator to sure the book link only navigates to the wikipedia page if a book link exists as it is optional
  const cardContent = (
