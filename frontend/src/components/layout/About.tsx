const About = () => {
  return (
    <section className="flex flex-col justify-center items-center text-white w-[70%] my-[80px] mx-auto p-10 bg-black shadow-[1px_1px_20px_white] sm:p-24 ">
      ...
      Book Vault is your personal digital library—designed to help you track, manage, and fall deeper in love with your reading journey. Whether you’re a casual reader or an avid bookworm (like me!), this app was built to make your collection feel beautifully organized and uniquely yours.
      </p>
      ...
      <ul className="about__list">
        <li className="list-none pb-3 text-start text-sm sm:text-xl">
          <strong>Create & Customize:</strong> Easily add books with all the essential info—title, author, year, image, and more. Update and delete your entries anytime.
        </li>
        <li className="list-none pb-3 text-start text-sm sm:text-xl">
          <strong>Save to Collection:</strong>  Click the save button to add a book to your personal collection. Want to unsave? Just one click, and it's gone!
        </li>
        <li className="list-none pb-3 text-start text-sm sm:text-xl">
          <strong>Browse Library:</strong> Discover all of the books saved to your account with
          striking covers and classic must-reads, always available to explore.
        </li>
        <li className="list-none pb-3 text-start text-sm sm:text-xl">
      ...
      <h2 className="font-bold text:large sm:text-2xl py-3">About the Developer:</h2>
      <p className=" list-none pb-3 text-start text-sm sm:text-xl">
